...
print
'The following non-word tokens will not be extracted from the pretrained embeddings: ', non_word_tokens
...
parser.add_argument("--apply_spelling_corrections", action='store_true',
                    help="If true, will apply spelling corrections to all words not found in the pretrained word embedding dictionary. These corrections are based on regex expressions and the enchant spelling corrector.")
...
for key in str_to_idx.iterkeys():
    ...
    if key in non_word_tokens:
        ...
        print
        'Assuming ' + str(key) + ' -> ' + str(key[0:len(key) - 1])
            ...
            if word_was_found == False:
                ...
                for suggestion in suggestions:
                    if (suggestion in allowed_suggestions) and (suggestion in embedding_dict):
                        ...
                        word_was_found = True
                        print
                        'Correcting ' + str(key) + ' -> ' + str(suggestion)
                        break
...
print
'unique_words_left_out', unique_words_left_out
